...
import com.example.adminapp.databinding.ActivityUploadQuestionsBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnUploadQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (correct == -1){
                    Toast.makeText(UploadQuestionsActivity.this, "Sselect correct option", Toast.LENGTH_SHORT).show();
                    return;
                }
